...
public static class LuaBinder
{
	...
	public static void Bind(IntPtr L, string type = null)
	{
		...
		switch (type) {
			...
			case "GConsoleCoreWrap": GConsoleCoreWrap.Register(L); break;
			case "GConsoleWrap": GConsoleWrap.Register(L); break;
			...
			case "NavMeshAgentWrap": NavMeshAgentWrap.Register(L); break;
