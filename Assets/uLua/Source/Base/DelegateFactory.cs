...
public static class DelegateFactory
{
	...
	public static Delegate Func_string_string_string(LuaFunction func)
	{
		Func<string,string,string> d = (param0, param1) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
	...
	public static Delegate GConsole_GConsoleListener(LuaFunction func)
	{
		GConsole.GConsoleListener d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
	...
	public static Delegate Func_string_string(LuaFunction func)
	{
		Func<string,string> d = (param0) =>
		{
			int top = func.BeginPCall();
			IntPtr L = func.GetLuaState();
			LuaScriptMgr.Push(L, param0);
